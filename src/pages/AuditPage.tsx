...
export default function AuditPage() {
  ...
  const actionColor: Record<string, string> = {
    ...
    DRAWER_ADD: 'bg-emerald-50 text-emerald-700 border-emerald-200',
    DRAWER_REMOVE: 'bg-red-50 text-red-700 border-red-200',
    DRAWER_RECONCILE: 'bg-amber-50 text-amber-700 border-amber-200',
